...
{
    /**
     * Types d'utilisateurs dans Passe Voyage
     * - ADMIN : Administrateur de la plateforme (accès complet)
     * - AGENT : Agent Terrain ou Collaborateur interne
     * - PARTNER : Partenaire (ex: représentant de compagnie de transport)
     */
    const USER_TYPE = [
        'ADMIN' => 'ADMIN',
        'AGENT' => 'AGENT',
    ...
    /**
     * Rôles Symfony correspondant aux types d'utilisateurs
     */
    const USER_ROLES = [
        'ADMIN' => 'ROLE_ADMIN',
        'AGENT' => 'ROLE_AGENT',
    ...
    /**
     * Statuts d'un Remboursement (Recouvrement)
     */
    ...
    /**
     * Types de paiements acceptés pour les remboursements
     */
    const PAIEMENT_TYPE = [
        'ESPECES' => 'ESPECES',
        'VIREMENT' => 'VIREMENT',
    ...
    /**
     * Statuts d'une Compagnie Partenaire
     */

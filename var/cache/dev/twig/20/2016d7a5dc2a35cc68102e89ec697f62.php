...
class __TwigTemplate_ecc44788e141c3f833a6923ac65849f4 extends Template
{
...
";
    ...
    public function block_lead(array $context, array $blocks = []): iterable
    {
        ...
        // line 2
        yield (string) CoreExtension::getAttribute($this->env, $this->source, (isset($context["email"]) || array_key_exists("email", $context) ? $context["email"] : (function () { throw new RuntimeError('Variable "email" does not exist.', 2, $this->source); })()), "subject", [], "any", false, false, false, 2);
        yield "
";
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield (string) (isset($context["content"]) || array_key_exists("content", $context) ? $context["content"] : (function () { throw new RuntimeError('Variable "content" does not exist.', 6, $this->source); })());
        yield "
";
    ...
    public function block_action(array $context, array $blocks = []): iterable
    {
        ...
        if ((($tmp = (isset($context["action_url"]) || array_key_exists("action_url", $context) ? $context["action_url"] : (function () { throw new RuntimeError('Variable "action_url" does not exist.', 10, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 11
            yield (string) (isset($context["action_text"]) || array_key_exists("action_text", $context) ? $context["action_text"] : (function () { throw new RuntimeError('Variable "action_text" does not exist.', 11, $this->source); })());
            yield ": ";
            yield (string) (isset($context["action_url"]) || array_key_exists("action_url", $context) ? $context["action_url"] : (function () { throw new RuntimeError('Variable "action_url" does not exist.', 11, $this->source); })());
            yield "
";
        }
...
";
            // line 18
            yield (string) (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new RuntimeError('Variable "exception" does not exist.', 18, $this->source); })());
            yield "
";
        }
    ...
    {
        return array (  153 => 18,  150 => 17,  148 => 16,  138 => 15,  125 => 11,  123 => 10,  113 => 9,  103 => 6,  93 => 5,  83 => 2,  73 => 1,  65 => 15,  62 => 14,  60 => 9,  57 => 8,  55 => 5,  52 => 4,  50 => 1,);
    }
...
{% endif %}
{% endblock %}
", "@email/zurb_2/notification/body.txt.twig", "/Users/mac/Documents/GBAT-DEV/pass-voyage-api/vendor/symfony/twig-bridge/Resources/views/Email/zurb_2/notification/body.txt.twig");
    }
}

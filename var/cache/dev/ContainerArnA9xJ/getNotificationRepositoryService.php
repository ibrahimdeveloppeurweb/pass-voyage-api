...
{
    /**
     * Gets the private 'App\Repository\Extra\NotificationRepository' shared autowired service.
     *
     * @return \App\Repository\Extra\NotificationRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/Extra/NotificationRepository.php';

        return $container->privates['App\\Repository\\Extra\\NotificationRepository'] = new \App\Repository\Extra\NotificationRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}

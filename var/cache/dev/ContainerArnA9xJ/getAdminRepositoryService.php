...
{
    /**
     * Gets the private 'App\Repository\Admin\AdminRepository' shared autowired service.
     *
     * @return \App\Repository\Admin\AdminRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/Admin/AdminRepository.php';

        return $container->privates['App\\Repository\\Admin\\AdminRepository'] = new \App\Repository\Admin\AdminRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}

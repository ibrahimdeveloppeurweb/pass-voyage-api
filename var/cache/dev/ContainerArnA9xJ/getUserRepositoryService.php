...
{
    /**
     * Gets the private 'App\Repository\Admin\UserRepository' shared autowired service.
     *
     * @return \App\Repository\Admin\UserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/Admin/UserRepository.php';

        return $container->privates['App\\Repository\\Admin\\UserRepository'] = new \App\Repository\Admin\UserRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}

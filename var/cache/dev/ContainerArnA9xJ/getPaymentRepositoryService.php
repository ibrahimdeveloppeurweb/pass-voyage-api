...
{
    /**
     * Gets the private 'App\Repository\Business\PaymentRepository' shared autowired service.
     *
     * @return \App\Repository\Business\PaymentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/Business/PaymentRepository.php';

        return $container->privates['App\\Repository\\Business\\PaymentRepository'] = new \App\Repository\Business\PaymentRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}

 ...
 */
class getDebug_Security_EventDispatcher_ApiLoginService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'debug.security.event_dispatcher.api_login' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [#[\Closure(name: 'security.listener.user_checker.api_login', class: 'Symfony\\Component\\Security\\Http\\EventListener\\UserCheckerListener')] fn () => ($container->privates['security.listener.user_checker.api_login'] ?? $container->load('getSecurity_Listener_UserChecker_ApiLoginService')), 'preCheckCredentials'], 256);
        $instance->addListener('security.authentication.success', [#[\Closure(name: 'security.listener.user_checker.api_login', class: 'Symfony\\Component\\Security\\Http\\EventListener\\UserCheckerListener')] fn () => ($container->privates['security.listener.user_checker.api_login'] ?? $container->load('getSecurity_Listener_UserChecker_ApiLoginService')), 'postCheckCredentials'], 256);
        ...
        return $container->privates['debug.security.event_dispatcher.api_login'] = $instance;
    }
}

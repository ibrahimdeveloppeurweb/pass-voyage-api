...
class getDoctrineMigrations_StatusCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Doctrine\Migrations\Tools\Console\Command\StatusCommand(($container->privates['doctrine.migrations.dependency_factory'] ?? $container->load('getDoctrine_Migrations_DependencyFactoryService')), 'doctrine:migrations:status');

        $instance->setName('doctrine:migrations:status');
        $instance->setDescription('View the status of a set of migrations.');

        return $container->privates['doctrine_migrations.status_command'] = $instance;
    }
}

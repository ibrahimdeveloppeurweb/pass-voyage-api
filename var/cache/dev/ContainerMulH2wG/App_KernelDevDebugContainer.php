...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\Admin\\PathController' => 'getPathControllerService',
            'App\\Controller\\Admin\\RoleController' => 'getRoleControllerService',
            'App\\Controller\\Admin\\UserController' => 'getUserControllerService',
            'App\\Controller\\Business\\AgentController' => 'getAgentControllerService',
            'App\\Controller\\Business\\CompanyController' => 'getCompanyControllerService',
            'App\\Controller\\Business\\CompanyFundController' => 'getCompanyFundControllerService',
            'App\\Controller\\Business\\CompanyInvoiceController' => 'getCompanyInvoiceControllerService',
            'App\\Controller\\Business\\CreditController' => 'getCreditControllerService',
            'App\\Controller\\Business\\CreditPolicyController' => 'getCreditPolicyControllerService',
            'App\\Controller\\Business\\PassengerController' => 'getPassengerControllerService',
            'App\\Controller\\Business\\RouteController' => 'getRouteControllerService',
            'App\\Controller\\Business\\StationController' => 'getStationControllerService',
            'App\\Controller\\Business\\TariffController' => 'getTariffControllerService',
            'App\\Controller\\Business\\TicketController' => 'getTicketControllerService',
            'App\\Controller\\CompanyController' => 'getCompanyController2Service',
            'App\\Controller\\Dashboard\\DashboardController' => 'getDashboardControllerService',
            'App\\Controller\\Extra\\GeneralSettingController' => 'getGeneralSettingControllerService',
            'App\\Controller\\Extra\\ServerController' => 'getServerControllerService',
            'App\\Controller\\Extra\\SharedController' => 'getSharedControllerService',
            'App\\Controller\\Extra\\UploaderController' => 'getUploaderControllerService',
            'App\\Controller\\Printer\\CreditRequestPrinterController' => 'getCreditRequestPrinterControllerService',
            'App\\Controller\\PublicAgentController' => 'getPublicAgentControllerService',
            'App\\Controller\\PublicReferentialController' => 'getPublicReferentialControllerService',
            'App\\Controller\\PublicRegistrationController' => 'getPublicRegistrationControllerService',
    ...
    protected static function getEventDispatcherService($container)
    {
        try {
            ...
            $instance->addListener('lexik_jwt_authentication.on_authentication_success', [#[\Closure(name: 'App\\Events\\LoginSubscriber')] fn () => ($container->privates['App\\Events\\LoginSubscriber'] ?? $container->load('getLoginSubscriberService')), 'attachDataToToken'], 10);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\Admin\\PathController', 'App\\Controller\\Admin\\RoleController', 'App\\Controller\\Admin\\UserController', 'App\\Controller\\Business\\AgentController', 'App\\Controller\\Business\\CompanyController', 'App\\Controller\\Business\\CompanyFundController', 'App\\Controller\\Business\\CompanyInvoiceController', 'App\\Controller\\Business\\CreditController', 'App\\Controller\\Business\\CreditPolicyController', 'App\\Controller\\Business\\PassengerController', 'App\\Controller\\Business\\RouteController', 'App\\Controller\\Business\\StationController', 'App\\Controller\\Business\\TariffController', 'App\\Controller\\Business\\TicketController', 'App\\Controller\\CompanyController', 'App\\Controller\\Dashboard\\DashboardController', 'App\\Controller\\Extra\\GeneralSettingController', 'App\\Controller\\Extra\\ServerController', 'App\\Controller\\Extra\\SharedController', 'App\\Controller\\Extra\\UploaderController', 'App\\Controller\\Printer\\CreditRequestPrinterController', 'App\\Controller\\PublicAgentController', 'App\\Controller\\PublicReferentialController', 'App\\Controller\\PublicRegistrationController', 'App\\Controller\\Security\\SecurityController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
        ...
        $instance = new \Symfony\Component\HttpKernel\HttpKernel($a, new \Symfony\Component\HttpKernel\Controller\TraceableControllerResolver($b, $c), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), new \Symfony\Component\HttpKernel\Controller\TraceableArgumentResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver(new \Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadataFactory(), new RewindableGenerator(function () use ($container) {
            ...
            yield 6 => ($container->privates['.debug.value_resolver.argument_resolver.uid'] ?? $container->load('get_Debug_ValueResolver_ArgumentResolver_UidService'));
            yield 7 => ($container->privates['.debug.value_resolver.argument_resolver.datetime'] ?? $container->load('get_Debug_ValueResolver_ArgumentResolver_DatetimeService'));
            yield 8 => ($container->privates['.debug.value_resolver.argument_resolver.request_attribute'] ?? $container->load('get_Debug_ValueResolver_ArgumentResolver_RequestAttributeService'));
    ...
    /**
     * Gets the private '.service_locator.RSs15qJ' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_RSs15qJService($container)
    {
        $instance = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'security.firewall.map.context.api_public' => ['privates', 'security.firewall.map.context.api_public', 'getSecurity_Firewall_Map_Context_ApiPublicService', true],
            ...
            'security.firewall.map.context.api_forgot' => ['privates', 'security.firewall.map.context.api_forgot', 'getSecurity_Firewall_Map_Context_ApiForgotService', true],
            'security.firewall.map.context.api_refresh' => ['privates', 'security.firewall.map.context.api_refresh', 'getSecurity_Firewall_Map_Context_ApiRefreshService', true],
            ...
            'security.firewall.map.context.api_forgot' => '?',
            'security.firewall.map.context.api_refresh' => '?',
            'security.firewall.map.context.api' => '?',
        ]);

        if (isset($container->privates['.service_locator.RSs15qJ'])) {
            return $container->privates['.service_locator.RSs15qJ'];
        }

        return $container->privates['.service_locator.RSs15qJ'] = $instance;
    }
    ...
    {
        $instance = new \Symfony\Component\Mime\MimeTypes();

        $instance->setDefault($instance);

        return $container->privates['mime_types'] = $instance;
    }
    ...
    {
        $a = ($container->privates['.service_locator.RSs15qJ'] ?? self::get_ServiceLocator_RSs15qJService($container));
        ...
        $instance = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () use ($container) {
            ...
            yield 'security.firewall.map.context.api_public' => ($container->privates['.security.request_matcher.Ekr_bG8'] ?? $container->load('get_Security_RequestMatcher_EkrBG8Service'));
            ...
            yield 'security.firewall.map.context.api_forgot' => ($container->privates['.security.request_matcher.ErTMGRi'] ?? $container->load('get_Security_RequestMatcher_ErTMGRiService'));
            yield 'security.firewall.map.context.api_refresh' => ($container->privates['.security.request_matcher.LCEZTJr'] ?? $container->load('get_Security_RequestMatcher_LCEZTJrService'));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'lexik_jwt_authentication.token_ttl' => 315360000,

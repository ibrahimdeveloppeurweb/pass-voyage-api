 ...
 */
class getDebug_Security_EventDispatcher_ApiForgotService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'debug.security.event_dispatcher.api_forgot' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [#[\Closure(name: 'security.listener.user_checker.api_forgot', class: 'Symfony\\Component\\Security\\Http\\EventListener\\UserCheckerListener')] fn () => ($container->privates['security.listener.user_checker.api_forgot'] ?? $container->load('getSecurity_Listener_UserChecker_ApiForgotService')), 'preCheckCredentials'], 256);
        $instance->addListener('security.authentication.success', [#[\Closure(name: 'security.listener.user_checker.api_forgot', class: 'Symfony\\Component\\Security\\Http\\EventListener\\UserCheckerListener')] fn () => ($container->privates['security.listener.user_checker.api_forgot'] ?? $container->load('getSecurity_Listener_UserChecker_ApiForgotService')), 'postCheckCredentials'], 256);
        ...
        return $container->privates['debug.security.event_dispatcher.api_forgot'] = $instance;
    }
}

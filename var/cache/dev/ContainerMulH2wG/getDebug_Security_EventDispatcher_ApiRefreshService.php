 ...
 */
class getDebug_Security_EventDispatcher_ApiRefreshService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'debug.security.event_dispatcher.api_refresh' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\CheckPassportEvent', [#[\Closure(name: 'security.listener.user_checker.api_refresh', class: 'Symfony\\Component\\Security\\Http\\EventListener\\UserCheckerListener')] fn () => ($container->privates['security.listener.user_checker.api_refresh'] ?? $container->load('getSecurity_Listener_UserChecker_ApiRefreshService')), 'preCheckCredentials'], 256);
        $instance->addListener('security.authentication.success', [#[\Closure(name: 'security.listener.user_checker.api_refresh', class: 'Symfony\\Component\\Security\\Http\\EventListener\\UserCheckerListener')] fn () => ($container->privates['security.listener.user_checker.api_refresh'] ?? $container->load('getSecurity_Listener_UserChecker_ApiRefreshService')), 'postCheckCredentials'], 256);
        ...
        return $container->privates['debug.security.event_dispatcher.api_refresh'] = $instance;
    }
}

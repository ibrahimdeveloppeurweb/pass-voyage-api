...
class getDoctrineMigrations_DumpSchemaCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Doctrine\Migrations\Tools\Console\Command\DumpSchemaCommand(($container->privates['doctrine.migrations.dependency_factory'] ?? $container->load('getDoctrine_Migrations_DependencyFactoryService')), 'doctrine:migrations:dump-schema');

        $instance->setName('doctrine:migrations:dump-schema');
        $instance->setDescription('Dump the schema for your database to a migration.');

        return $container->privates['doctrine_migrations.dump_schema_command'] = $instance;
    }
}
